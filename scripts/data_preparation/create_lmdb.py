...
def create_lmdb_for_div2k():
    ...
    """
    # HR images
    # folder_path = '/output/datasets/dehaze_derain/Rain_Raindrop/HR/'
    # lmdb_path = '/output/datasets/dehaze_derain/Rain_Raindrop_lmdb/HR.lmdb'
    # img_path_list, keys = prepare_keys_div2k(folder_path)
    # make_lmdb_from_imgs(folder_path, lmdb_path, img_path_list, keys)

    # LRx2 images
    folder_path = '/output/datasets/dehaze_derain/Rain_Raindrop/LR_expand/X2'
    lmdb_path = '/output/datasets/dehaze_derain/Rain_Raindrop_lmdb/LR_expand.lmdb'
    img_path_list, keys = prepare_keys_div2k(folder_path)
    make_lmdb_from_imgs(folder_path, lmdb_path, img_path_list, keys)
...
def prepare_keys_div2k(folder_path):
    ...
    keys = [img_path.split('x2.png')[0] for img_path in sorted(img_path_list)]
