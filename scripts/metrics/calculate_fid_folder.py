...
def calculate_fid_folder():
    ...
    parser.add_argument('--fid_stats', type=str, help='Path to the dataset fid statistics.', default='experiments/pretrained_models/pt_inception-2015-12-05-6726825d.pth')
