...
if __name__ == '__main__':
    ...
    parser.add_argument('--input', type=str, default='/home/IR/results/RainDS_real/rainstreak_raindrop/DiffIR_rainstreak_raindrop/visualization/RainDS2_rainstreak_raindrop/', help='Input path')
